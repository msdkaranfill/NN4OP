...
// #define PRECISION_PMM_VALUES (1.0e-7)
...
class PMM_MG_Trajectory3D{
    public:
         ...
         */
        PMM_MG_Trajectory3D(const int n_path_segments, const Scalar v_max = MAX_SCALAR);
         ...
         */
        PMM_MG_Trajectory3D(std::vector<Vector<3>> p, std::vector<Vector<3>> v, Vector<3> a_max, const Scalar v_max = MAX_SCALAR);
         ...
         */
        PMM_MG_Trajectory3D(std::vector<Vector<3>> p, std::vector<Vector<3>> v, Vector<3> a_min, Vector<3> a_max, const Scalar v_max = MAX_SCALAR);
         ...
         */
        PMM_MG_Trajectory3D(std::vector<Vector<3>> p, std::vector<Vector<3>> v, Vector<3> a_min, Vector<3> a_max, const Scalar v_max, bool equalize_axes);
         ...
         */
        PMM_MG_Trajectory3D(std::vector<Vector<3>> p, std::vector<Vector<3>> v, const Scalar max_acc_norm, const Scalar v_max, const int td_max_iter=10,
                            const Scalar td_acc_norm_precision_limit=1e-3, const bool debug=false);
         ...
         * @param max_acc_norm Norm of the maximal acceleration of the done given its limited thrust
        ...
        PMM_MG_Trajectory3D(std::vector<Vector<3>> waypoints, const Vector<3> start_vel, const Vector<3> end_vel,
                                            const Scalar max_acc_norm, const Scalar v_max, const Scalar dT_precision = 1e-3, const int GD_max_iter = 30, 
                                            ...
                                            const Scalar GD_alpha_min_thr_2nd_rnd = 1e-2, const bool debug = false);
        ...
        int optimize_velocities_at_positions(Scalar gd_step=0.5, Scalar gd_step_reduction_factor=0.5, Scalar gd_step_min_threshold=1e-3,
                                            int max_iter=100, Scalar dT_threshold=1e-5, int single_axis_optim_idx=-1, bool debug=false,
         ...
         * @return int Success
         */
        int updateTrajectoryGivenVelocities(std::vector<Vector<3>> v_new, const bool equalize_times, const bool sync_traj=false);
         ...
         * @return int Success
         */
        int updateTrajectoryGivenVelocities(Vector<3> v_new, const int segment_idx, const bool equalize_times, const bool sync_traj=false);
        ...
        PMM_MG_Trajectory3D operator=(PMM_MG_Trajectory3D tr);
...
std::vector<Vector<3>> compute_initial_velocities(std::vector<Vector<3>> waypoints, Vector<3> start_velocity,
                     Vector <3> end_velocity, const Scalar max_per_axis_acc, const Scalar v_max, const double const_vel_norm = -1);
